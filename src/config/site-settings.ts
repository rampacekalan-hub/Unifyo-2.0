  ...
  pricing: [
    ...
    },
    {
      ...
      features: [
        ...
        { text: "SLA — garantovaná odpoveď do 2 h", included: true },
        { text: "Fakturácia SK/ČR formát", included: true },
        { text: "GDPR súlad & DPA podpis", included: true },
        { text: "Dedikovaný success manager", included: true },
        { text: "Vlastní AI agenti (neobmedzene)", included: false, tooltip: "Plánované" },
