...
export default function MeshBackground() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      beam.addColorStop(0, "rgba(124,58,237,0.18)");
      beam.addColorStop(0.3, "rgba(124,58,237,0.07)");
      beam.addColorStop(0.6, "rgba(37,99,235,0.03)");
      ...
      coneGrad.addColorStop(0, "rgba(167,139,250,0.1)");
      coneGrad.addColorStop(0.4, "rgba(124,58,237,0.04)");
      ...
      const bottomGlow = ctx.createRadialGradient(
        canvas.width * 0.8, canvas.height, 0,
        canvas.width * 0.8, canvas.height, canvas.width * 0.5
      );
      bottomGlow.addColorStop(0, `rgba(37,99,235,${0.04 + Math.sin(t) * 0.01})`);
      ...
      orbGrad.addColorStop(0, "rgba(124,58,237,0.06)");
