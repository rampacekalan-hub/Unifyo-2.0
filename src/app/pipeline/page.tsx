      ...
      <div className="p-4 md:p-6 flex flex-col h-full">
        ...
        {loading ? (
          ...
          <EmptyState
            Icon={Plus}
            tone="primary"
            title="Zatiaľ žiadne dealy"
            description="Pipeline drží tvoje obchodné príležitosti od prvého kontaktu po uzavretie. Pridaj prvý — stačí názov, zvyšok doplníš neskôr."
            cta={{ label: "Vytvoriť prvý deal", onClick: () => setShowNew({ stage: "LEAD" }) }}
          />
        ) : (
